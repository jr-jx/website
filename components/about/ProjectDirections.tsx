    ...
    <section ref={sectionRef} className="relative py-24">
      <div className="container mx-auto px-6">
        <PageHeader
          badge="项目方向"
          title="技术发展方向"
          subtitle="我们专注于前沿技术领域，通过实际项目实践，帮助成员掌握核心技术，提升实战能力。"
        />
        ...
        <div ref={cardsRef} className="max-w-7xl mx-auto mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {directions.map((direction) => {
              ...
              return (
                <PageCard key={direction.title} gradient className="p-6">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold mb-2 text-foreground">{direction.title}</h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">{direction.description}</p>
                    </div>
                  </div>
                  
                  <div className="space-y-2">
                    <h4 className="text-sm font-semibold text-foreground">代表项目：</h4>
        ...
        <div className="text-center">
          <PageCard className="max-w-4xl mx-auto p-8">
            <h3 className="text-2xl font-bold mb-4 text-foreground">加入我们的技术探索之旅</h3>
